...
person.opacity{14} = [0.3 0];
person.opacity{17} = [0.3 0];

%% offsets for visualisation

person.offset{1} =  [0; 0;  0];
person.offset{2} =  [0; 0; 50];
person.offset{3} =  [0; 0; 50];
person.offset{4} =  [0; 0; 50];
person.offset{5} =  [0; 0; 50];
person.offset{6} =  [0; 0; 50];
person.offset{7} =  [0; 0; 50];
person.offset{8} =  [0; 0; 50];
person.offset{9} =  [0; 0; 50];
person.offset{10} = [0; 0; 50];
person.offset{11} = [0; 0; 50];
person.offset{12} = [0; 0; 50];
person.offset{13} = [0; 0; 50];
person.offset{14} = [0; 0; 50];
person.offset{15} = [0; 0; 50];
...
[thorax_length,person] = segment_abdomino_thoracic(person,1,hatze1,hatze2,hatze11);
...
person = segment_shoulder(person,3,'l',thorax_length,left_arm_diameters);
...
person = segment_shoulder(person,7,'r',thorax_length,right_arm_diameters);
